...
cout<<"detectio 4"<<endl;
        ...
        while (edge11x<=0 && edge11y<=0 && edge12x<=0 && edge21y<=0)
        ...
        //{
            ...
            for(;;)
               {int Nf=5;
                ...
                /* if (corners0.size()==0 || nextcorners.size()==0 || corners.size()==0)
            {
                printf("Il nous faut une autre detection\n");
                corners0.resize(1);
                nextcorners.resize(1);
                corners.resize(1);

                corners0[0].x=1;    corners0[0].y=1;
                nextcorners[0].x=1; nextcorners[0].y=1;
                ...
                for (int i=0;i<nextcorners.size();i++){
                 ...
                 //   printf("x=%d ;   y=%d\n",nextcorners[i].x,nextcorners[i].y);
                }


                for( int i = 0; i < corners.size(); i++ )
                {
                    arrowedLine(copy,           //picture where to draw
