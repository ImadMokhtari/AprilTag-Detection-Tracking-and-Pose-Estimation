...
void Features_Tracking::Show_Detection(Mat src,vector<Point2f> tag_Points)
{
...
vector<Point2f> Features_Tracking::Show_Tracking_Homography(Mat src,vector<Point2f> tag_points,Mat H)
{
